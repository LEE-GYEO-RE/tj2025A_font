...
// - 속성명과 자료의 한쌍(entry) 하고 ,(쉼표)로 구분하여 여러개의 쌍(entry)을 { } 로 감싼다. 
// - 속성명은 임의로 작성하되 , 특수문자가 포함된 경우는 '' , "" 로 문자 처리
// - 속성명은 자료를 식별하는 목적으로 중복이름이 불가능하다.
...
// [4] 객체 호출
    ...
    // Object.keys( 객체 변수 )  : 객체 내 모든 속성명(key) 를 배열로 반환
...
// [5] 객체내 속성 추가
// - 변수명.새로운속성명 = 자료 , 변수명['새로운속성명'] = 자료
obj2.속성명3 = true;
console.log( obj2 ); // {속성명1: 10, 속성명2: 'hello', 속성명3: true}

// [6] 객체내 속성 수정
// - 변수명.속성명 = 새로운 자료 , 변수명['속성명'] = 새로운 자료
obj2.속성명1 =20;
...
// [8] 객체 속성내 자료 
// - 자료에는 변수값 , 리터럴값 , 객체 , 배열 , 함수 등 모든 자료가 대입된다.
let var1 = 10;
const var2 = { 
